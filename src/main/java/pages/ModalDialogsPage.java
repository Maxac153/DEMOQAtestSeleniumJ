...
public class ModalDialogsPage {
    public static String checkSmallModal(WebDriver driver) {
        ...
        String result = driver.findElement(ModalDialogsLocators.SMALL_MODAL_BODY).getText();
        driver.findElement(ModalDialogsLocators.CLOSE_SMALL_BUTTON);
        return result;
    }
    ...
    public static String checkLargeModal(WebDriver driver) {
        ...
        driver.findElement(ModalDialogsLocators.CLOSE_LARGE_MODAL_BODY);
        return result;
    }
}

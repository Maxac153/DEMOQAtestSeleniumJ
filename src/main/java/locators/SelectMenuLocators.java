...
public class SelectMenuLocators {
    ...
    public static final By REMOVE_GREEN = By.xpath("//div[text()='Green']");
    public static final By REMOVE_BLUE = By.xpath("//div[text()='Blue']");
    public static final By REMOVE_BLACK = By.xpath("//div[text()='Black']");
    public static final By REMOVE_RED = By.xpath("//div[text()='Red']");
}
